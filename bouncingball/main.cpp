...
#include <math.h>
#include <time.h>
#define radius 0.5 //Radius of sphere
...
GLfloat Wwidth;
GLfloat Wheight;
GLfloat x; // X position of balls
GLfloat y; // Y position of balls
GLfloat z; //z Position of balls
...
static void key(unsigned char key, int x, int y)
{
    ...
    case ' ': // Spacebar key
        ...
        sphereY = 0.0;
        sphereZ = 0.0;
        color[0] = 1.0f; // Reset ball color to white
        color[1] = 1.0f;
        color[2] = 1.0f;
        break;
    }
...
static void init(void)
{
    ...
    // Set starting color of the balls to white
    color[0] = 1.0f;
    color[1] = 1.0f;
    color[2] = 1.0f;
}
